...
const PRICE_LABELS = [0, 10, 20, 30, 40, 50, 60];
const SLIDER_LENGTH = SCREEN_WIDTH - 96;
const MAX_INDEX = PRICE_LABELS.length - 1; // 6

export default function SquareMetersFilter({ values, onValuesChangeFinish }) {
  ...
  return (
    <View style={styles.transactionTypeFilterWrapper}>
      ...
      <View style={styles.buttonStyle}>
        <Pressable>
          <Text style={styles.inputText}>직접 입력</Text>
        </Pressable>
        <Pressable
